...
(() => {
    ...
    var Z = class extends HTMLElement {
            ...
            connectedCallback() {
                ...
                !this.shadowRoot ||
                    ...
                    (this.shadowRoot.innerHTML = `
           <style>${it}</style>
           <div class="popup" style="position: absolute; left: -238px; top: -246px; background: none; border: none; box-shadow: none;">
    ...
    var Ut = {
        ...
        tt = class extends HTMLElement {
            ...
            <div class="color-picker" style="background: none; border: none;">
