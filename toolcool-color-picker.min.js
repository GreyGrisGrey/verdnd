...
(() => {
    ...
    var Ut = {
        ...
        tt = class extends HTMLElement {
            ...
            <button style="background: none; border: none; position: absolute; top: 6px; left: 3px; color: rgba(220, 220, 220, 1);" id="colPickerButton">Colour</button>
        ...
        `),
            ...
            toggleButton(buttonToggle) {
                this.shadowRoot.getElementById('colPickerButton').style.color =
                    buttonToggle
                        ? 'rgba(220, 220, 220, 1)'
                        : 'rgba(255, 255, 255, 1)';
            }
