...
(() => {
    ...
    var l = (function () {
        ...
        return (
            ...
            (o.prototype.toHexShortString = function (e) {
                return (
                    e === void 0 && (e = !1),
    ...
    var j = class extends HTMLElement {
            ...
            hueChanged(t) {
                console.log(this.hue, Number(t.detail.h));
                if (Number(t.detail.h) === this.hue) {
                    return;
                }
                !t ||
                    !t.detail ||
        ...
        `),
                    ...
                    (x = this.$saturation) == null ||
                        x.addEventListener('touchmove', this.onChange),
                    (w = this.$saturation) == null ||
                        w.addEventListener('touchstart', this.onChange),
    ...
    var J = class extends HTMLElement {
            ...
            hueChanged(t) {
                const curr = this.color.toHsv();
                if (Number(t.detail.h) === curr.h) {
                    return;
                }
                if (
                    !t ||
           ...
           <style>${Et}</style>
           <div class="fields">
               <input id="hex-${i}" type="text" value="${this.hex.toUpperCase()}" data-type="hex" style="color:rgba(255, 255, 255, 1);background-color:rgba(50, 50, 50, 1);border-color: rgba(80, 80, 80, 1);"/>
               <input id="r-${r}" type="text" value="${this.r}" data-type="r" style="color:rgba(255, 255, 255, 1);background-color:rgba(50, 50, 50, 1);border-color: rgba(80, 80, 80, 1);"/>
               <input id="g-${n}" type="text" value="${this.g}" data-type="g" style="color:rgba(255, 255, 255, 1);background-color:rgba(50, 50, 50, 1);border-color: rgba(80, 80, 80, 1);"/>
               <input id="b-${s}" type="text" value="${this.b}" data-type="b" style="color:rgba(255, 255, 255, 1);background-color:rgba(50, 50, 50, 1);border-color: rgba(80, 80, 80, 1);"/>
               <input id="a-${a}" type="text" value="${Math.round(this.a * 100)}" data-type="a" style="color:rgba(255, 255, 255, 1);background-color:rgba(50, 50, 50, 1);border-color: rgba(80, 80, 80, 1);"/>
               
               <label for="hex-${i}" style="color:rgba(255, 255, 255, 1);">Hex</label>
               <label for="r-${r}" style="color:rgba(255, 255, 255, 1);">R</label>
               <label for="g-${n}" style="color:rgba(255, 255, 255, 1);">G</label>
               <label for="b-${s}" style="color:rgba(255, 255, 255, 1);">B</label>
               <label for="a-${a}" style="color:rgba(255, 255, 255, 1);">A</label>
           </div>
        `),
    ...
    var Z = class extends HTMLElement {
            ...
            connectedCallback() {
                ...
                !this.shadowRoot ||
                    ...
                    (this.shadowRoot.innerHTML = `
           <style>${it}</style>
           <div class="popup" style="position: absolute; left: -230px; top: -38px; z-index: 33; background: none; border: none; box-shadow: none;">
    ...
    var Ut = {
        ...
        tt = class extends HTMLElement {
            ...
            onPopupVisibilityChange() {
                !this.$popupBox ||
                    (this.$popupBox.innerHTML = this.state.isPopupVisible
                        ? `<toolcool-color-picker-popup color="${this.state.color.toRgbString()}" cid="${this.cid}" popup-position="${this.state.popupPosition}" style="background: none; border: none;" />`
                        : '');
            }
            onPopupPosChange() {
            ...
            hsvChanged(t) {
                const curr = this.state.color.toHsv();
                if (
                    t.detail.h === curr.h &&
                    t.detail.s === curr.s &&
                    t.detail.v === curr.v
            ...
            hueChanged(t) {
                const curr = this.state.color.toHsv();
                console.log(curr.h, t.detail.h);
                if (t.detail.h === curr.h) {
                    return;
                }
                if (
                    !t ||
            ...
            <button style="background: none; border: none; position: absolute; top: 6px; left: 3px; color: rgba(255, 255, 255, 1);" id="colPickerButton">Colour</button>
            <div class="color-picker" style="background: none; border: none; position: absolute;">
